        ...
        return (
            <div className="flex items-center justify-center py-20">
                <div className="text-center">
                    <div className="animate-spin rounded-full h-12 w-12 border-b-4 border-[#1C2B6A] mx-auto mb-4"></div>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white/60 rounded-xl shadow-sm border border-amber-200/40 p-4">
                <div className="relative">
                    ...
                    />
                    <svg
                        className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-[#1C2B6A]"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                    >
                                                ...
                                                <div className="h-12 w-12 flex-shrink-0 rounded-lg overflow-hidden bg-amber-50 border border-amber-100">
                                                    {trip.imageUrl ? (
                                                        ...
                                                        <div className="h-full w-full flex items-center justify-center">
                                                            <svg className="w-6 h-6 text-[#1C2B6A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div className="flex items-center justify-end gap-2">
                                                <Link
                                                    ...
                                                    className="text-[#1C2B6A] hover:text-[#eace83] transition-colors"
                                                    title="View Details"
                                                >
